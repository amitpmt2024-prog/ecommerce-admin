  ...
  const handleDeleteConfirm = async () => {
    ...
    try {
      ...
      if (response.status) {
        ...
        setDeleteError(response.message || "Failed to delete user. Please try again.");
      ...
      setDeleteError("An error occurred while deleting the user. Please try again.");
      // Clear error after 3 seconds
      setTimeout(() => {
        setDeleteError(null);
      }, 3000);
        ...
        <div className="dark:bg-blackPrimary bg-whiteSecondary py-10">
          ...
          {loading ? (
            <div className="px-4 sm:px-6 lg:px-8 mt-6 text-center">
              <p className="dark:text-whiteSecondary text-blackPrimary">Loading users...</p>
            </div>
          ) : error ? (
            <div className="px-4 sm:px-6 lg:px-8 mt-6 text-center">
